...
export default function registerCreateTest(
  ...
  server.tool(
    ...
    'Create a new test case in a project',
    {
      ...
      testName: z.string().min(1).describe('Test name/title'),
      testDescription: z.string().optional().describe('Test description'),
    ...
    async (params) => {
      try {
        ...
        return handleApiResponse(data, `create test "${params.testName}"`, [

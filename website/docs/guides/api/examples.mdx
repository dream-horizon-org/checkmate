...
- [Download OpenAPI Spec →](https://github.com/dream-horizon-org/checkmate/blob/master/openapi.yaml)

:::tip
  Have a use case not covered here? [Open an issue](https://github.com/dream-horizon-org/checkmate/issues) or join our [Discord](https://discord.gg/wBQXeYAKNc)!
:::

...
<Tabs>
  <TabItem value="API Token (Recommended)" icon="seti:json">
  ...
  **Response:**
  ...
  <TabItem value="Session Cookie" icon="cookie">
...
<Tabs>
  <TabItem value="JavaScript" icon="seti:javascript">
  ...
  <TabItem value="Node.js" icon="seti:node">
...
- [Check OpenAPI Spec →](https://github.com/dream-horizon-org/checkmate/blob/master/openapi.yaml)

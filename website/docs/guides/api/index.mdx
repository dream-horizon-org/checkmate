...
<CardGrid>
  ...
  <Card title="OpenAPI Spec" icon="document">
    ...
    [Download OpenAPI →](https://github.com/dream-horizon-org/checkmate/blob/master/openapi.yaml)
  </Card>
</CardGrid>
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/dream-horizon-org/checkmate/issues)

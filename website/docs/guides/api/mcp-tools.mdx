...
> **📖 Detailed Guide Available**: For comprehensive setup instructions with troubleshooting, see the [Complete Cursor Setup Guide](https://github.com/ds-horizon/checkmate/blob/master/mcp-server/CURSOR_SETUP.md).
...
- ✓ Use absolute path for `index.js`

...
<Tabs>
  ...
  <TabItem label="Docker (Full Stack)">
...
<CardGrid>
  ...
  <Card title="Contributing" icon="github">
    ...
    [View Guidelines →](https://github.com/dream-sports-labs/checkmate/blob/master/CONTRIBUTING.md)
  </Card>
</CardGrid>
...
- **GitHub Repository:** [dream-sports-labs/checkmate](https://github.com/dream-sports-labs/checkmate)
- **Discord Community:** [Join Discord](https://discord.gg/wBQXeYAKNc)
- **Report Issues:** [GitHub Issues](https://github.com/dream-sports-labs/checkmate/issues)

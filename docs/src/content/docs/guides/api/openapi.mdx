...
description: Access and use the Checkmate OpenAPI 3.0 specification
---

import { Steps, Aside, Card, CardGrid, LinkCard } from '@astrojs/starlight/components';

The Checkmate API is documented using the **OpenAPI 3.0** standard, providing a machine-readable specification that can be used with various API tools and generators.

## Download OpenAPI Spec

<LinkCard
  title="Download openapi.yaml"
  description="Download the complete OpenAPI 3.0 specification"
  href="/openapi.yaml"
/>
